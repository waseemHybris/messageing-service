...
class MessageDtoToUnityMessageConvertorTest
{
	...
	@InjectMocks
	private MessageDtoToUnityMessageConvertor messageDtoToUnityMessageConvertor;
	@Mock
	...
	void should_convert() throws JsonProcessingException
	{
		...
		var entity = messageDtoToUnityMessageConvertor.convert("tenant", msg);
