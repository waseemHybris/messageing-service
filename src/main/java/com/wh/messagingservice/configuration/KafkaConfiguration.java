package com.wh.messagingservice.configuration;
...
public class KafkaConfiguration
{
	...
	KafkaTemplate<String, MessageDto> standaloneKafkaTemplate(ProducerFactory messageProducerFactory)
	{
		KafkaTemplate<String, MessageDto> kafkaTemplate = new KafkaTemplate(messageProducerFactory);
