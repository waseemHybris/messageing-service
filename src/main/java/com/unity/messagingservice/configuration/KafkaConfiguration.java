...
public class KafkaConfiguration
{
	...
	public NewTopic topic() {
		return new NewTopic("unityMessageQueue", 1, (short) 1);
	}
	...
	@Bean
	public KafkaTemplate<String, MessageDto> unityMessageKafkaTemplate() {
		return new KafkaTemplate<>(unityMessageProducerFactory());
	}
